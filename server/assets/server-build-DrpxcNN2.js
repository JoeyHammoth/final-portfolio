...
import { createContext, useContext, forwardRef, useRef, useEffect, useState, memo, Fragment, useCallback, lazy, Suspense, useId, useMemo, Children, useSyncExternalStore } from "react";
...
const GothamBoldItalic = "/final-portfolio/assets/gotham-bold-italic-C_msAlmW.woff2";
const GothamBold = "/final-portfolio/assets/gotham-bold-D1kvQ7KV.woff2";
const GothamBookItalic = "/final-portfolio/assets/gotham-book-italic-Bm2IEtSK.woff2";
const GothamBook = "/final-portfolio/assets/gotham-book-Bnaws0Ef.woff2";
const GothamMediumItalic = "/final-portfolio/assets/gotham-medium-italic-Dok430ou.woff2";
const GothamMedium = "/final-portfolio/assets/gotham-medium-0VT3RO8I.woff2";
const IPAGothic = "/final-portfolio/assets/ipa-gothic-DimHCOud.woff2";
const media = {
  desktop: 2080,
  laptop: 1680,
  tablet: 1040,
...
const notFoundVideo = "/final-portfolio/assets/notfound-Cfa33_DP.mp4";
...
const flatlineVideo = "/final-portfolio/assets/flatline-DaiGY3H4.mp4";
const icon$2 = "_icon_1tdl1_2";
const styles$C = {
  icon: icon$2
};
const sprites = "/final-portfolio/assets/icons-CWCWx_g_.svg";
const Icon = forwardRef(({ icon: icon2, className, size, ...rest }, ref) => {
  return /* @__PURE__ */ jsx(
    "svg",
    {
      "aria-hidden": true,
      ref,
      className: classes(styles$C.icon, className),
      width: size || 24,
      height: size || 24,
      ...rest,
...
const Loader = forwardRef(
  ({ className, style, width = 32, height = 4, text: text2 = "Loading...", center, ...rest }, ref) => {
    ...
    if (reduceMotion) {
      return /* @__PURE__ */ jsx(Text, { className: classes(styles$A.text, className), weight: "medium", ...rest, children: text2 });
    }
    return /* @__PURE__ */ jsx(
      "div",
      {
        ref,
        className: classes(styles$A.loader, className),
        "data-center": center,
        style: cssProps({ width, height }, style),
        ...rest,
        children: /* @__PURE__ */ jsx("div", { className: styles$A.span })
      }
    );
  }
);
...
const ButtonContent = forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsxs(
      Component,
      {
        className: classes(styles$z.button, className),
        ...
        children: [
          ...
          !!children && /* @__PURE__ */ jsx("span", { className: styles$z.text, children }),
...
const VisuallyHidden = forwardRef(
  ({ className, showOnFocus, as: Component = "span", children, visible, ...rest }, ref) => {
    return /* @__PURE__ */ jsx(
      Component,
      {
        className: classes(styles$y.hidden, className),
...
const DecoderText = memo(
  ({ text: text2, start = true, delay: startDelay = 0, className, ...rest }) => {
    ...
    useEffect(() => {
      ...
      const renderOutput = () => {
        const characterMap = output.current.map((item2) => {
          return `<span class="${styles$x[item2.type]}">${item2.value}</span>`;
        });
    ...
    return /* @__PURE__ */ jsxs("span", { className: classes(styles$x.text, className), ...rest, children: [
      /* @__PURE__ */ jsx(VisuallyHidden, { className: styles$x.label, children: text2 }),
      /* @__PURE__ */ jsx("span", { "aria-hidden": true, className: styles$x.content, ref: container2 })
    ] });
  }
);
...
const Heading = ({
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsx(
    Component,
    {
      className: classes(styles$w.heading, className),
      "data-align": align,
      "data-weight": weight,
...
const Image$1 = ({
  ...
  return /* @__PURE__ */ jsx(
    "div",
    {
      className: classes(styles$u.image, className),
...
const ImageElements = ({
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      className: styles$u.elementWrapper,
      "data-reveal": reveal,
      "data-visible": inViewport || loaded,
      ...
      children: [
        isVideo && hasMounted && /* @__PURE__ */ jsxs(Fragment, { children: [
          ...
          !noPauseButton && /* @__PURE__ */ jsxs(Button, { className: styles$u.button, onClick: togglePlaying, children: [
        ...
        showPlaceholder && /* @__PURE__ */ jsx(
          ...
          {
            "aria-hidden": true,
            className: styles$u.placeholder,
            "data-loaded": loaded,
            "data-cover": cover,
...
const flatlineSkull = "/final-portfolio/assets/error-flatline-eK98OAAk.svg";
function Error$1({ error: error2 }) {
  ...
  return /* @__PURE__ */ jsxs("section", { className: styles$v.page, children: [
    ...
    /* @__PURE__ */ jsx(Transition, { in: true, children: ({ visible }) => /* @__PURE__ */ jsxs(Fragment$1, { children: [
      /* @__PURE__ */ jsx("div", { className: styles$v.details, children: /* @__PURE__ */ jsxs("div", { className: styles$v.text, children: [
        !flatlined && /* @__PURE__ */ jsx(
          Heading,
          {
        ...
        flatlined && /* @__PURE__ */ jsxs(
          Heading,
          {
            className: styles$v.titleFlatline,
            "data-visible": visible,
            level: 2,
            as: "h1",
            children: [
        ...
        /* @__PURE__ */ jsx(Text, { className: styles$v.description, "data-visible": visible, as: "p", children: message }),
        flatlined ? /* @__PURE__ */ jsx(
          Button,
          {
            secondary: true,
      ...
      /* @__PURE__ */ jsxs("div", { className: styles$v.videoContainer, "data-visible": visible, children: [
        /* @__PURE__ */ jsx(
          Image$1,
          {
            reveal: true,
...
const name$2 = "James Nikolas Putradi";
const role$1 = "Software Engineer";
const disciplines = [
  "Full Stack",
  "Cloud",
  "Devops",
...
const url$1 = "https://jamesputradi.tech";
const figma = "@jputradi";
const github = "JoeyHammoth";
const repo = "https://github.com/JoeyHammoth/portfolio";
...
const logo$1 = "_logo_zzi78_27";
const nav = "_nav_zzi78_2";
const navList = "_navList_zzi78_51";
const navLink$2 = "_navLink_zzi78_59";
const navIcons$2 = "_navIcons_zzi78_102";
const navIconLink$2 = "_navIconLink_zzi78_126";
const navIcon$2 = "_navIcon_zzi78_102";
...
const Navbar = () => {
  ...
  useRef();
  windowSize.width <= media.mobile || windowSize.height <= 696;
...
`
  ...
  return /* @__PURE__ */ jsxs("html", { lang: "en", children: [
    /* @__PURE__ */ jsxs("head", { children: [
      ...
      /* @__PURE__ */ jsx("meta", { name: "theme-color", content: theme === "dark" ? "#111" : "#0F6158" }),
      /* @__PURE__ */ jsx(
        "meta",
        {
          name: "color-scheme",
    ...
    /* @__PURE__ */ jsxs("body", { "data-theme": theme, children: [
      /* @__PURE__ */ jsxs(ThemeProvider, { theme, toggleTheme, children: [
        ...
        /* @__PURE__ */ jsx(VisuallyHidden, { showOnFocus: true, as: "a", className: styles$r.skip, href: "#main-content", children: "Skip to main content" }),
        /* @__PURE__ */ jsx(Navbar, {}),
        /* @__PURE__ */ jsx(
          "main",
          {
...
const volkiharBackgroundLarge = "/final-portfolio/assets/volkihar-background-large-BNfdj2Th.jpg";
...
const volkiharBackground = "/final-portfolio/assets/volkihar-background-BwfMx1oT.jpg";
const volkiharBannerLarge = "/final-portfolio/assets/volkihar-banner-large-B7psY5Jh.jpg";
...
const volkiharBanner = "/final-portfolio/assets/volkihar-banner-C736rbFi.jpg";
const volkiharBookLarge = "/final-portfolio/assets/volkihar-book-large-BpE5vkX8.png";
const volkiharBookPlaceholder = "/final-portfolio/assets/volkihar-book-placeholder-tOpZR4Vi.png";
const volkiharBook = "/final-portfolio/assets/volkihar-book-B73D4Zfh.png";
const volkiharEnderalLarge = "/final-portfolio/assets/volkihar-enderal-large-T2LUjM5-.jpg";
const volkiharEnderalLogoLarge = "/final-portfolio/assets/volkihar-enderal-logo-large-BbiR1dg4.png";
...
const volkiharEnderalLogo = "/final-portfolio/assets/volkihar-enderal-logo-Bg2oXoo9.png";
...
const volkiharEnderal = "/final-portfolio/assets/volkihar-enderal-BTf8JKtt.jpg";
const volkiharSlide1Large = "/final-portfolio/assets/volkihar-slide-1-large-CkekFT3C.jpg";
const volkiharSlide1 = "/final-portfolio/assets/volkihar-slide-1-BJOjWYAS.jpg";
const volkiharSlide2Large = "/final-portfolio/assets/volkihar-slide-2-large-BzyjkLqK.jpg";
const volkiharSlide2 = "/final-portfolio/assets/volkihar-slide-2-1Kh0pCzp.jpg";
const volkiharSlide3Large = "/final-portfolio/assets/volkihar-slide-3-large-C_8CrUhH.jpg";
const volkiharSlide3 = "/final-portfolio/assets/volkihar-slide-3-Dkb5mX5r.jpg";
...
const Link = forwardRef(
  ({ rel, target, children, secondary, className, href, ...rest }, ref) => {
    ...
    const linkProps = {
      className: classes(styles$q.link, className),
      ["data-secondary"]: secondary,
      rel: relValue,
      href,
      target: targetValue,
...
const date$2 = "_date_gmxrz_20";
const styles$p = {
  footer: footer$1,
  link,
  date: date$2
};
const Footer = ({ className }) => /* @__PURE__ */ jsx("footer", { className: classes(styles$p.footer, className), children: /* @__PURE__ */ jsxs(Text, { size: "s", align: "center", children: [
  /* @__PURE__ */ jsx("span", { className: styles$p.date, children: `© ${(/* @__PURE__ */ new Date()).getFullYear()} Built by ${config.name} with ❤️` }),
  /* @__PURE__ */ jsx("p", { style: { color: "#3b3b3b" }, children: "Special thanks to HamishMW and Kevin Zhou" })
] }) });
...
const Section = forwardRef(
  ({ as: Component = "div", children, className, ...rest }, ref) => /* @__PURE__ */ jsx(Component, { className: classes(styles$o.section, className), ref, ...rest, children })
);
...
const image$3 = "_image_7xwsz_327";
...
function ProjectHeader({
  ...
  return /* @__PURE__ */ jsx(Section, { className: classes(styles$n.header, className), as: "section", children: /* @__PURE__ */ jsxs(
    "div",
    {
      className: styles$n.headerContent,
      style: cssProps({ initDelay: numToMs(initDelay) }),
      children: [
        /* @__PURE__ */ jsxs("div", { className: styles$n.details, children: [
          /* @__PURE__ */ jsx(Heading, { className: styles$n.title, level: 2, as: "h1", children: title2 }),
          /* @__PURE__ */ jsx(Text, { className: styles$n.description, size: "xl", as: "p", children: description2 }),
          !!url2 && /* @__PURE__ */ jsx(
            Button,
            {
              secondary: true,
              iconHoverShift: true,
              className: styles$n.linkButton,
              icon: "chevron-right",
              href: url2,
              children: linkLabel
            }
        ...
        !!(roles2 == null ? void 0 : roles2.length) && /* @__PURE__ */ jsx("ul", { className: styles$n.meta, children: roles2 == null ? void 0 : roles2.map((role2, index2) => /* @__PURE__ */ jsx(
          "li",
          {
            className: styles$n.metaItem,
...
const ProjectContainer = ({ className, ...rest }) => /* @__PURE__ */ jsx("article", { className: classes(styles$n.project, className), ...rest });
const ProjectSection = forwardRef(
  ({
    ...
    "section",
    {
      className: classes(styles$n.section, className),
      "data-light": light2,
      ...
      children: [
        !!backgroundElement && /* @__PURE__ */ jsx(
          "div",
          {
            className: styles$n.sectionBackground,
            style: cssProps({ opacity: backgroundOverlayOpacity }),
            children: backgroundElement
          }
        ),
        /* @__PURE__ */ jsx(Section, { className: styles$n.sectionInner, "data-padding": padding, children })
      ]
    }
  )
);
const ProjectBackground = ({ opacity = 0.7, className, ...rest }) => {
  ...
  return /* @__PURE__ */ jsx(Transition, { in: true, timeout: msToNum(tokens.base.durationM), children: ({ visible, nodeRef }) => /* @__PURE__ */ jsxs(
    "div",
    {
      className: classes(styles$n.backgroundImage, className),
      "data-visible": visible,
      ref: nodeRef,
      children: [
        /* @__PURE__ */ jsx("div", { className: styles$n.backgroundImageElement, ref: imageRef, children: /* @__PURE__ */ jsx(Image$1, { cover: true, alt: "", role: "presentation", ...rest }) }),
        /* @__PURE__ */ jsx("div", { className: styles$n.backgroundScrim, style: cssProps({ opacity }) })
      ]
    }
  ) });
};
const ProjectImage = ({ className, alt, ...rest }) => /* @__PURE__ */ jsx("div", { className: classes(styles$n.image, className), children: /* @__PURE__ */ jsx(Image$1, { reveal: true, alt, delay: 300, ...rest }) });
const ProjectSectionContent = ({ className, width = "l", ...rest }) => /* @__PURE__ */ jsx(
  "div",
  {
    className: classes(styles$n.sectionContent, className),
    "data-width": width,
    ...rest
  }
);
const ProjectSectionHeading = ({ className, level = 3, as = "h2", ...rest }) => /* @__PURE__ */ jsx(
  Heading,
  {
    className: classes(styles$n.sectionHeading, className),
    as,
    level,
    align: "auto",
    ...rest
...
const ProjectSectionText = ({ className, ...rest }) => /* @__PURE__ */ jsx(Text, { className: classes(styles$n.sectionText, className), size: "l", as: "p", ...rest });
const ProjectTextRow = ({
  ...
  "div",
  {
    className: classes(styles$n.textRow, className),
    "data-center": center,
...
const ProjectSectionColumns = ({ className, centered, ...rest }) => /* @__PURE__ */ jsx(
  ...
  {
    className: classes(styles$n.sectionColumns, className),
...
const Carousel = lazy(
  () => import("./index-CcxrR3xl.js").then((module) => ({ default: module.Carousel }))
);
const Armor = lazy(() => import("./armor-BgtTt2o-.js").then((module) => ({ default: module.Armor })));
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs(ProjectContainer, { children: [
      ...
      /* @__PURE__ */ jsx(ProjectSection, { children: /* @__PURE__ */ jsxs(ProjectSectionColumns, { children: [
        /* @__PURE__ */ jsx("div", { className: styles$m.armor, children: /* @__PURE__ */ jsx(Suspense, { children: /* @__PURE__ */ jsx(Armor, { alt: "3D model of the Volkihar Knight armor" }) }) }),
        /* @__PURE__ */ jsxs("div", { className: styles$m.textSection, children: [
      ...
      /* @__PURE__ */ jsx(ProjectSection, { children: /* @__PURE__ */ jsxs(ProjectSectionContent, { children: [
        /* @__PURE__ */ jsx("div", { className: styles$m.logoContainer, children: /* @__PURE__ */ jsx(
          VolkiharLogo,
          {
            role: "img",
...
const backgroundSprLarge = "/final-portfolio/assets/spr-background-large-nYeU3Kau.jpg";
...
const imageSprBackgroundVolcanismLarge = "/final-portfolio/assets/spr-background-volcanism-large-t0jgu3IX.jpg";
const imageSprBackgroundVolcanismPlaceholder = "/final-portfolio/assets/spr-background-volcanism-placeholder-BMmyN9Lv.jpg";
const imageSprBackgroundVolcanism = "/final-portfolio/assets/spr-background-volcanism-bmTr0iXr.jpg";
const backgroundSpr = "/final-portfolio/assets/spr-background-BYcr6wKu.jpg";
const imageSprComponentsDarkLarge = "/final-portfolio/assets/spr-components-dark-large-DDLZMiq_.png";
const imageSprComponentsDarkPlaceholder = "/final-portfolio/assets/spr-components-dark-placeholder-CS7TACCT.png";
const imageSprComponentsDark = "/final-portfolio/assets/spr-components-dark-C4JG7Pbq.png";
const imageSprComponentsLightLarge = "/final-portfolio/assets/spr-components-light-large-DsBvVT1Z.png";
const imageSprComponentsLightPlaceholder = "/final-portfolio/assets/spr-components-light-placeholder-CszPt9Ak.png";
const imageSprComponentsLight = "/final-portfolio/assets/spr-components-light-B7eB4kK-.png";
const imageSprDesignSystemDarkLarge = "/final-portfolio/assets/spr-design-system-dark-large-Dqc1QDG6.png";
const imageSprDesignSystemDarkPlaceholder = "/final-portfolio/assets/spr-design-system-dark-placeholder-BnG6UVwD.png";
const imageSprDesignSystemDark = "/final-portfolio/assets/spr-design-system-dark-m_r7zp6p.png";
const imageSprDesignSystemLightLarge = "/final-portfolio/assets/spr-design-system-light-large-DpW3ORXR.png";
const imageSprDesignSystemLightPlaceholder = "/final-portfolio/assets/spr-design-system-light-placeholder-rqb9V2TD.png";
const imageSprDesignSystemLight = "/final-portfolio/assets/spr-design-system-light-BDN1DcyF.png";
const imageSprLessonBuilderDarkLarge = "/final-portfolio/assets/spr-lesson-builder-dark-large-DZ47e5rw.jpg";
const sprTexturePlaceholder = "/final-portfolio/assets/spr-lesson-builder-dark-placeholder-BYjrS8rr.jpg";
const imageSprLessonBuilderDark = "/final-portfolio/assets/spr-lesson-builder-dark-CleNpN1U.jpg";
const imageSprLessonBuilderLightLarge = "/final-portfolio/assets/spr-lesson-builder-light-large-BcyuLqHy.jpg";
const imageSprLessonBuilderLightPlaceholder = "/final-portfolio/assets/spr-lesson-builder-light-placeholder-Dq8oUDzc.jpg";
const imageSprLessonBuilderLight = "/final-portfolio/assets/spr-lesson-builder-light-UMmbA8fJ.jpg";
const videoSprMotionLarge = "/final-portfolio/assets/spr-motion-large-3xc88jM5.mp4";
...
const videoSprMotion = "/final-portfolio/assets/spr-motion-DNnC5DgY.mp4";
const imageSprSchema1DarkLarge = "/final-portfolio/assets/spr-schema-1-dark-large-CeSqw0xT.png";
...
const imageSprSchema1Dark = "/final-portfolio/assets/spr-schema-1-dark-DrL_5NQ4.png";
const imageSprSchema1LightLarge = "/final-portfolio/assets/spr-schema-1-light-large-CkTsXpYP.png";
...
const imageSprSchema1Light = "/final-portfolio/assets/spr-schema-1-light-B5dEN2xi.png";
const imageSprSchema2DarkLarge = "/final-portfolio/assets/spr-schema-2-dark-large-WIGUIqzX.png";
const imageSprSchema2DarkPlaceholder = "/final-portfolio/assets/spr-schema-2-dark-placeholder-BVZ4WW8t.png";
const imageSprSchema2Dark = "/final-portfolio/assets/spr-schema-2-dark-DYmNi06o.png";
const imageSprSchema2LightLarge = "/final-portfolio/assets/spr-schema-2-light-large-h4BJSsho.png";
...
const imageSprSchema2Light = "/final-portfolio/assets/spr-schema-2-light-B53tZDTp.png";
const imageSprStoryboarderDarkLarge = "/final-portfolio/assets/spr-storyboarder-dark-large-CILuJaRq.png";
...
const imageSprStoryboarderDark = "/final-portfolio/assets/spr-storyboarder-dark-BuwX6fEO.png";
const imageSprStoryboarderLightLarge = "/final-portfolio/assets/spr-storyboarder-light-large-Cs7Lwjrs.png";
...
const imageSprStoryboarderLight = "/final-portfolio/assets/spr-storyboarder-light-DqGEXS8o.png";
const container$1 = "_container_vdycn_2";
const options = "_options_vdycn_6";
const button$4 = "_button_vdycn_26";
...
const Earth = lazy(() => import("./earth-CrKIE3Jr.js").then((module) => ({ default: module.Earth })));
const EarthSection = lazy(
  () => import("./earth-CrKIE3Jr.js").then((module) => ({ default: module.EarthSection }))
);
...
function ArticlesPost({ slug, frontmatter: frontmatter2, timecode: timecode2, index: index2 }) {
  ...
  return /* @__PURE__ */ jsxs(
    "article",
    {
      className: styles$i.post,
      "data-featured": !!featured,
      style: index2 !== void 0 ? cssProps({ delay: index2 * 100 + 200 }) : void 0,
      children: [
        featured && /* @__PURE__ */ jsx(Text, { className: styles$i.postLabel, size: "s", children: "Featured" }),
        featured && !!banner2 && /* @__PURE__ */ jsx("div", { className: styles$i.postImage, children: /* @__PURE__ */ jsx(
          Image$1,
          {
            noPauseButton: true,
        ...
        /* @__PURE__ */ jsx(
          Link$1,
          {
            ...
            prefetch: "intent",
            to: `/articles/${slug}`,
            className: styles$i.postLink,
            onMouseEnter: handleMouseEnter,
            onMouseLeave: handleMouseLeave,
            children: /* @__PURE__ */ jsxs("div", { className: styles$i.postDetails, children: [
              /* @__PURE__ */ jsxs("div", { "aria-hidden": true, className: styles$i.postDate, children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: styles$i.postFooter, children: [
                /* @__PURE__ */ jsx(Button, { secondary: true, iconHoverShift: true, icon: "chevron-right", as: "div", children: "Read article" }),
                /* @__PURE__ */ jsx(Text, { className: styles$i.timecode, size: "s", children: timecode2 })
              ] })
            ] })
          }
        ),
        featured && /* @__PURE__ */ jsx(Text, { "aria-hidden": true, className: styles$i.postTag, size: "s", children: "477" })
      ]
    }
  );
}
function SkeletonPost({ index: index2 }) {
  return /* @__PURE__ */ jsx(
    ...
    {
      "aria-hidden": "true",
      className: classes(styles$i.post, styles$i.skeleton),
      "data-featured": "false",
      style: index2 !== void 0 ? cssProps({ delay: index2 * 100 + 200 }) : void 0,
      children: /* @__PURE__ */ jsx("div", { className: styles$i.postLink, children: /* @__PURE__ */ jsxs("div", { className: styles$i.postDetails, children: [
        /* @__PURE__ */ jsxs("div", { "aria-hidden": true, className: styles$i.postDate, children: [
          /* @__PURE__ */ jsx(Divider, { notchWidth: "64px", notchHeight: "8px" }),
          "Coming soon..."
        ] }),
        /* @__PURE__ */ jsx(
          Heading,
          {
            className: styles$i.skeletonBone,
            as: "h2",
            level: 4,
        ...
        /* @__PURE__ */ jsxs("div", { className: styles$i.postFooter, children: [
          ...
          /* @__PURE__ */ jsx(Text, { className: styles$i.timecode, size: "s", children: "00:00:00:00" })
        ] })
      ] }) })
    }
  );
...
function Articles$1() {
  ...
  const postsHeader = /* @__PURE__ */ jsxs("header", { className: styles$i.header, children: [
    /* @__PURE__ */ jsx(Heading, { className: styles$i.heading, level: 5, as: "h1", children: /* @__PURE__ */ jsx(DecoderText, { text: "Latest articles" }) }),
    /* @__PURE__ */ jsx(Barcode, { className: styles$i.barcode })
  ] });
  const postList = /* @__PURE__ */ jsxs("div", { className: styles$i.list, children: [
  ...
  return /* @__PURE__ */ jsxs("article", { className: styles$i.articles, children: [
    /* @__PURE__ */ jsxs(Section, { className: styles$i.content, children: [
      !isSingleColumn && /* @__PURE__ */ jsxs("div", { className: styles$i.grid, children: [
        postList,
        featuredPost
      ] }),
      isSingleColumn && /* @__PURE__ */ jsxs("div", { className: styles$i.grid, children: [
...
const sliceAnnotationLarge = "/final-portfolio/assets/slice-annotation-large-BMgELH_L.png";
const sliceAnnotationPlaceholder = "/final-portfolio/assets/slice-annotation-placeholder-CCGEuhhx.png";
const sliceAnnotation = "/final-portfolio/assets/slice-annotation-BYMGWVwS.png";
const sliceAppLarge = "/final-portfolio/assets/slice-app-large-CHKPTcWm.jpg";
...
const sliceApp = "/final-portfolio/assets/slice-app-PoRtkkeP.jpg";
const sliceBackgroundBarLarge = "/final-portfolio/assets/slice-background-bar-large-CYHGpgXa.jpg";
...
const sliceBackgroundBar = "/final-portfolio/assets/slice-background-bar-DUyfyeHo.jpg";
const sliceBackgroundLarge = "/final-portfolio/assets/slice-background-large-Dnpu52lB.jpg";
...
const sliceBackground = "/final-portfolio/assets/slice-background-5195om16.jpg";
...
const sliceIrl = "/final-portfolio/assets/slice-irl-Bok-9coc.jpg";
const sliceSidebarAnnotationsLarge = "/final-portfolio/assets/slice-sidebar-annotations-large-CrYJmPog.png";
const sliceSidebarAnnotationsPlaceholder = "/final-portfolio/assets/slice-sidebar-annotations-placeholder-Bewc5d-7.png";
const sliceSidebarAnnotations = "/final-portfolio/assets/slice-sidebar-annotations-CisIo7UR.png";
const sliceSidebarLayersLarge = "/final-portfolio/assets/slice-sidebar-layers-large-CqnA6hBc.png";
...
const sliceSidebarLayers = "/final-portfolio/assets/slice-sidebar-layers-jDBpAmZU.png";
const sliceSlidesLarge = "/final-portfolio/assets/slice-slides-large--yrOgN_x.jpg";
...
const sliceSlides = "/final-portfolio/assets/slice-slides-me7j0Hig.jpg";
...
const Slice = () => {
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs(ProjectContainer, { className: styles$h.slice, children: [
      /* @__PURE__ */ jsx(
        ProjectBackground,
        {
          src: sliceBackground,
      ...
      /* @__PURE__ */ jsx(ProjectSection, { children: /* @__PURE__ */ jsxs(ProjectSectionColumns, { centered: true, className: styles$h.columns, children: [
        /* @__PURE__ */ jsxs("div", { className: styles$h.imagesText, children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: styles$h.sidebarImages, children: [
          /* @__PURE__ */ jsx(
            Image$1,
            {
              className: styles$h.sidebarImage,
      ...
      /* @__PURE__ */ jsx(ProjectSection, { padding: "top", children: /* @__PURE__ */ jsxs(ProjectSectionContent, { className: styles$h.grid, children: [
        /* @__PURE__ */ jsxs("div", { className: styles$h.gridImage, children: [
          /* @__PURE__ */ jsx("div", { className: styles$h.gridBackground, children: /* @__PURE__ */ jsx(
            Image$1,
            {
          ...
          /* @__PURE__ */ jsx("div", { className: styles$h.gridForeground, children: /* @__PURE__ */ jsx(
            Image$1,
            {
        ...
        /* @__PURE__ */ jsxs("div", { className: styles$h.gridText, children: [
...
const headerText$1 = "_headerText_kr7uo_55";
const date$1 = "_date_kr7uo_79";
...
const content$4 = "_content_kr7uo_266";
const styles$g = {
  post,
  header,
...
const Post = ({ children, title: title2, date: date2, banner: banner2, timecode: timecode2 }) => {
  ...
  return /* @__PURE__ */ jsxs("article", { className: styles$g.post, children: [
    /* @__PURE__ */ jsxs(Section, { children: [
      banner2 && /* @__PURE__ */ jsxs("div", { className: styles$g.banner, ref: imageRef, children: [
        /* @__PURE__ */ jsx("div", { className: styles$g.bannerImage, children: /* @__PURE__ */ jsx(Image$1, { role: "presentation", src: banner2, placeholder: placeholder2, alt: "" }) }),
        /* @__PURE__ */ jsx("div", { className: styles$g.bannerImageBlur, children: /* @__PURE__ */ jsx(
          Image$1,
          {
            role: "presentation",
            src: placeholder2,
      ...
      /* @__PURE__ */ jsx("header", { className: styles$g.header, children: /* @__PURE__ */ jsxs("div", { className: styles$g.headerText, children: [
        /* @__PURE__ */ jsx(Transition, { in: true, timeout: msToNum(tokens.base.durationM), children: ({ visible, nodeRef }) => /* @__PURE__ */ jsxs("div", { className: styles$g.date, ref: nodeRef, children: [
          /* @__PURE__ */ jsx(Divider, { notchWidth: "64px", notchHeight: "8px", collapsed: !visible }),
          /* @__PURE__ */ jsx(Text, { className: styles$g.dateText, "data-visible": visible, children: dateTime })
        ] }) }),
        /* @__PURE__ */ jsx(Heading, { level: 2, as: "h1", className: styles$g.title, "aria-label": title2, children: title2.split(" ").map((word2, index2) => /* @__PURE__ */ jsx("span", { className: styles$g.titleWordWrapper, children: /* @__PURE__ */ jsxs(
          "span",
          {
            className: styles$g.titleWord,
        ...
        /* @__PURE__ */ jsxs("div", { className: styles$g.details, children: [
          ...
          /* @__PURE__ */ jsx("div", { className: styles$g.timecode, children: timecode2 })
        ] })
      ] }) })
    ] }),
    /* @__PURE__ */ jsx(Section, { className: styles$g.wrapper, id: "postContent", tabIndex: -1, children: /* @__PURE__ */ jsx(Text, { as: "div", size: "l", className: styles$g.content, children }) }),
    /* @__PURE__ */ jsx(Footer, {})
  ] });
};
...
const Code = (props) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: styles$f.code, "data-theme": theme, children: [
    !!lang2 && /* @__PURE__ */ jsx(Text, { secondary: true, size: "s", className: styles$f.lang, children: lang2 }),
    /* @__PURE__ */ jsx("pre", { ref: elementRef, ...props }),
    /* @__PURE__ */ jsx("div", { className: styles$f.actions, children: /* @__PURE__ */ jsx(Button, { iconOnly: true, onClick: handleCopy, "aria-label": "Copy", children: /* @__PURE__ */ jsxs("span", { className: styles$f.copyIcon, children: [
...
const List = ({ ordered, children, className, ...rest }) => {
  ...
  return /* @__PURE__ */ jsx(Element, { className: classes(styles$e.list, className), ...rest, children });
};
const ListItem = ({ children, ...rest }) => {
  return /* @__PURE__ */ jsx("li", { className: styles$e.item, ...rest, children });
};
...
const PostHeadingLink = ({ id }) => {
  return /* @__PURE__ */ jsx(Link$1, { className: styles$d.headingLink, to: `#${id}`, "aria-label": "Link to heading", children: /* @__PURE__ */ jsx(Icon, { icon: "link" }) });
};
const PostH1 = ({ children, id, ...rest }) => /* @__PURE__ */ jsxs(Heading, { className: styles$d.heading, id, level: 2, as: "h1", ...rest, children: [
  /* @__PURE__ */ jsx(PostHeadingLink, { id }),
  children
] });
const PostH2 = ({ children, id, ...rest }) => /* @__PURE__ */ jsxs(Heading, { className: styles$d.heading, id, level: 3, as: "h2", ...rest, children: [
  /* @__PURE__ */ jsx(PostHeadingLink, { id }),
  children
] });
const PostH3 = ({ children, id, ...rest }) => /* @__PURE__ */ jsxs(Heading, { className: styles$d.heading, id, level: 4, as: "h3", ...rest, children: [
  /* @__PURE__ */ jsx(PostHeadingLink, { id }),
  children
] });
const PostH4 = ({ children, id, ...rest }) => /* @__PURE__ */ jsxs(Heading, { className: styles$d.heading, id, level: 5, as: "h4", ...rest, children: [
  /* @__PURE__ */ jsx(PostHeadingLink, { id }),
  children
] });
const PostParagraph = ({ children, ...rest }) => {
  ...
  return /* @__PURE__ */ jsx(Text, { className: styles$d.paragraph, size: "l", as: "p", ...rest, children });
};
const PostLink = ({ ...props }) => /* @__PURE__ */ jsx(Link, { ...props });
const PostUl = (props) => {
  return /* @__PURE__ */ jsx(List, { className: styles$d.list, ...props });
};
const PostOl = (props) => {
  return /* @__PURE__ */ jsx(List, { className: styles$d.list, ordered: true, ...props });
};
const PostLi = ({ children, ...props }) => {
  return /* @__PURE__ */ jsx(ListItem, { ...props, children });
};
const PostCode = ({ children, ...rest }) => /* @__PURE__ */ jsx("code", { className: styles$d.code, ...rest, children });
const PostPre = (props) => {
  return /* @__PURE__ */ jsx("div", { className: styles$d.pre, children: /* @__PURE__ */ jsx(Code, { ...props }) });
};
const PostBlockquote = (props) => {
  return /* @__PURE__ */ jsx("blockquote", { className: styles$d.blockquote, ...props });
};
const PostHr = (props) => {
  return /* @__PURE__ */ jsx("hr", { className: styles$d.hr, ...props });
};
const PostStrong = (props) => {
  return /* @__PURE__ */ jsx("strong", { className: styles$d.strong, ...props });
};
...
const Embed = ({ src }) => {
  return /* @__PURE__ */ jsx("div", { className: styles$d.embed, children: /* @__PURE__ */ jsx("iframe", { src, loading: "lazy", title: "Embed" }) });
};
const postMarkdown = {
  h1: PostH1,
  h2: PostH2,
...
const TextArea = ({
  ...
  return /* @__PURE__ */ jsx(
    "textarea",
    {
      className: classes(styles$c.textarea, className),
      ref: textareaRef,
      onChange: handleChange,
...
const content$3 = "_content_1ukhq_16";
...
const Input = ({
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      className: classes(styles$b.container, className),
      "data-error": !!error2,
      style,
      ...rest,
      children: [
        /* @__PURE__ */ jsxs("div", { className: styles$b.content, children: [
          ...
          /* @__PURE__ */ jsx("div", { className: styles$b.underline, "data-focused": focused })
        ] }),
        /* @__PURE__ */ jsx(Transition, { unmount: true, in: error2, timeout: msToNum(tokens.base.durationM), children: ({ visible, nodeRef }) => {
          ...
          return /* @__PURE__ */ jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxs("div", { className: styles$b.errorMessage, ref: errorRef, children: [
...
const button$3 = "_button_xvg9q_144";
...
const Contact = () => {
  ...
  return /* @__PURE__ */ jsxs(Section, { className: styles$a.contact, children: [
            ...
            Transition,
            {
              ...
              children: ({ status: errorStatus, nodeRef: nodeRef2 }) => {
                ...
                return /* @__PURE__ */ jsx(
                  "div",
                  {
                    className: styles$a.formError,
                    ref: nodeRef2,
                    "data-status": errorStatus,
                    style: cssProps({
                      height: errorStatus ? (_a = errorRef.current) == null ? void 0 : _a.offsetHeight : 0
                    }),
                    children: /* @__PURE__ */ jsx("div", { className: styles$a.formErrorContent, ref: errorRef, children: /* @__PURE__ */ jsxs("div", { className: styles$a.formErrorMessage, children: [
                      /* @__PURE__ */ jsx(Icon, { className: styles$a.formErrorIcon, icon: "error" }),
    ...
    /* @__PURE__ */ jsx(Transition, { unmount: true, in: actionData == null ? void 0 : actionData.success, children: ({ status, nodeRef }) => /* @__PURE__ */ jsxs("div", { className: styles$a.complete, "aria-live": "polite", ref: nodeRef, children: [
      /* @__PURE__ */ jsx(
        Heading,
        {
          level: 3,
          as: "h3",
          className: styles$a.completeTitle,
          "data-status": status,
      ...
      /* @__PURE__ */ jsx(
        Text,
        {
          size: "l",
          as: "p",
          className: styles$a.completeText,
          "data-status": status,
      ...
      /* @__PURE__ */ jsx(
        Button,
        {
          secondary: true,
          iconHoverShift: true,
          className: styles$a.completeButton,
          "data-status": status,
    ...
    /* @__PURE__ */ jsx(Footer, { className: styles$a.footer })
  ] });
};
...
const intro = "_intro_1qygf_1";
const text = "_text_1qygf_9";
const sectionTitle = "_sectionTitle_1qygf_35";
const name = "_name_1qygf_40";
const title$3 = "_title_1qygf_78";
const row$1 = "_row_1qygf_82";
const word = "_word_1qygf_111";
const introTextReveal = "_introTextReveal_1qygf_1";
const line = "_line_1qygf_187";
const introLine = "_introLine_1qygf_1";
const scrollIndicator = "_scrollIndicator_1qygf_236";
const introScrollIndicator = "_introScrollIndicator_1qygf_1";
const mobileScrollIndicator = "_mobileScrollIndicator_1qygf_303";
const introMobileScrollIndicator = "_introMobileScrollIndicator_1qygf_1";
const styles$9 = {
  intro,
  text,
  sectionTitle,
...
const navLink$1 = "_navLink_fttoa_2";
const navIcons$1 = "_navIcons_fttoa_45";
const navIconLink$1 = "_navIconLink_fttoa_69";
const navIcon$1 = "_navIcon_fttoa_45";
const socialContainer = "_socialContainer_fttoa_89";
const styles$8 = {
  navLink: navLink$1,
  navIcons: navIcons$1,
  navIconLink: navIconLink$1,
  navIcon: navIcon$1,
  socialContainer
};
const linkedinIcon = "/final-portfolio/assets/linkedin-logo-Dzg0xrMW.png";
const Social = () => {
  return /* @__PURE__ */ jsxs("div", { className: styles$8.socialContainer, children: [
    /* @__PURE__ */ jsx(
      "a",
      {
        className: styles$8.navIconLink,
        "aria-label": "LinkedIn",
        href: "https://www.linkedin.com/in/jputradi/",
        target: "_blank",
        rel: "noopener noreferrer",
        children: /* @__PURE__ */ jsx("img", { src: linkedinIcon, alt: `linkedin logo`, className: styles$8.navIcon })
      },
      "LinkedIn"
    ),
    /* @__PURE__ */ jsx(
      "a",
      {
        className: styles$8.navIconLink,
        "aria-label": "LinkedIn",
        href: "https://github.com/JoeyHammoth",
        target: "_blank",
        rel: "noopener noreferrer",
        children: /* @__PURE__ */ jsx(Github, { className: styles$8.navIcon, icon: "github" })
      },
      "Github"
    )
  ] });
...
const DisplacementSphere = lazy(
  () => import("./displacement-sphere-DN7kDPrz.js").then((module) => ({ default: module.DisplacementSphere }))
);
    ...
    Section,
    {
      ...
      children: /* @__PURE__ */ jsx(Transition, { in: true, timeout: 3e3, children: ({ visible, status }) => /* @__PURE__ */ jsxs(Fragment$1, { children: [
        ...
        /* @__PURE__ */ jsxs("header", { className: styles$9.text, children: [
          /* @__PURE__ */ jsx("h1", { className: styles$9.name, "data-visible": visible, id: titleId, children: /* @__PURE__ */ jsx(DecoderText, { text: config.name, delay: 500 }) }),
          /* @__PURE__ */ jsxs(Heading, { level: 1, as: "h1", className: styles$9.title, children: [
...
const profileImgPlaceholder = "/final-portfolio/assets/profile-placeholder-DOgU6wR2.jpg";
const workshop = "/final-portfolio/assets/workshop-CUCM1aY0.jpg";
const profile$1 = "_profile_s38cy_1";
const content$2 = "_content_s38cy_37";
const column$1 = "_column_s38cy_50";
const title$2 = "_title_s38cy_59";
const description$2 = "_description_s38cy_70";
const tag$1 = "_tag_s38cy_80";
const tagText$1 = "_tagText_s38cy_93";
const image$1 = "_image_s38cy_114";
const svg$2 = "_svg_s38cy_119";
const button$2 = "_button_s38cy_135";
const styles$7 = {
  profile: profile$1,
  content: content$2,
  column: column$1,
...
const ProfileText = ({ visible, titleId }) => /* @__PURE__ */ jsxs(Fragment, { children: [
  /* @__PURE__ */ jsx(Heading, { className: styles$7.title, "data-visible": visible, level: 3, id: titleId, children: /* @__PURE__ */ jsx(DecoderText, { text: "Hello, I'm James!", start: visible, delay: 500 }) }),
  /* @__PURE__ */ jsxs(Text, { className: styles$7.description, "data-visible": visible, size: "l", as: "p", children: [
    "I'm a software engineer with extensive experience with ",
    /* @__PURE__ */ jsx("b", { children: "React" }),
    ", ",
    /* @__PURE__ */ jsx("b", { children: "Tailwind" }),
    ",",
    " ",
    /* @__PURE__ */ jsx("b", { children: "SwiftUI" }),
    " and have done DevOps work with ",
    /* @__PURE__ */ jsx("b", { children: "Kubernetes" }),
    " and",
    " ",
    /* @__PURE__ */ jsx("b", { children: "CI/CD" }),
    " pipelines.",
    /* @__PURE__ */ jsx("br", {}),
    /* @__PURE__ */ jsx("br", {}),
    "In the past, I have worked at the ",
    /* @__PURE__ */ jsx("b", { children: "Walter and Eliza Hall Institute" }),
    " and the ",
    " ",
    /* @__PURE__ */ jsx("b", { children: "University of Melbourne" }),
    ". Currently, I'm heavily involved at two burgeoning startups, ",
    /* @__PURE__ */ jsx("b", { children: "Scorkl" }),
    " ",
    "and ",
    /* @__PURE__ */ jsx("b", { children: "Sensure Medical" }),
    ".",
    /* @__PURE__ */ jsx("br", {}),
    /* @__PURE__ */ jsx("br", {}),
    "I love contributing to startups and learning about new technologies. I'm also actively involved in several university clubs,",
    " ",
...
const Profile = ({ id, visible, sectionRef }) => {
  ...
  return /* @__PURE__ */ jsx(
    Section,
    {
      ...
      "aria-labelledby": titleId,
      tabIndex: -1,
      children: /* @__PURE__ */ jsx(Transition, { in: visible || focused, timeout: 0, children: ({ visible: visible2, nodeRef }) => /* @__PURE__ */ jsxs("div", { className: styles$7.content, ref: nodeRef, children: [
        /* @__PURE__ */ jsx("div", { className: styles$7.column, children: /* @__PURE__ */ jsx(ProfileText, { visible: visible2, titleId }) }),
        /* @__PURE__ */ jsxs("div", { className: styles$7.column, children: [
          /* @__PURE__ */ jsxs("div", { className: styles$7.tag, "aria-hidden": true, children: [
            /* @__PURE__ */ jsx(
              Divider,
              {
                notchWidth: "64px",
            ...
            /* @__PURE__ */ jsx("div", { className: styles$7.tagText, "data-visible": visible2, children: "About me" })
          ] }),
          /* @__PURE__ */ jsx("div", { className: styles$7.image, children: /* @__PURE__ */ jsx(
            Image$1,
            {
              reveal: true,
              delay: 100,
...
const iphone11 = "/final-portfolio/assets/iphone-11-DGIHa_Ph.glb";
const macbookPro = "/final-portfolio/assets/macbook-pro-DZn-FKKF.glb";
...
const summary = "_summary_88fa7_1";
const content$1 = "_content_88fa7_35";
const details = "_details_88fa7_65";
const preview = "_preview_88fa7_78";
const model = "_model_88fa7_88";
const loader$1 = "_loader_88fa7_142";
const techstackContainer = "_techstackContainer_88fa7_151";
const svg$1 = "_svg_88fa7_160";
const index = "_index_88fa7_201";
const indexNumber = "_indexNumber_88fa7_210";
const title$1 = "_title_88fa7_231";
const description$1 = "_description_88fa7_250";
const button$1 = "_button_88fa7_270";
const styles$6 = {
  summary,
  content: content$1,
  details,
...
const Model = lazy(
  () => import("./index-dVNyPlZj.js").then((module) => ({ default: module.Model }))
);
function ProjectSummary({
  ...
  function renderDetails(visible) {
    return /* @__PURE__ */ jsxs("div", { className: styles$6.details, children: [
      /* @__PURE__ */ jsxs("div", { "aria-hidden": true, className: styles$6.index, children: [
        /* @__PURE__ */ jsx(
          Divider,
          {
            notchWidth: "64px",
        ...
        /* @__PURE__ */ jsx("span", { className: styles$6.indexNumber, "data-visible": visible, children: indexText })
      ] }),
      /* @__PURE__ */ jsx(
        Heading,
        {
      ...
      /* @__PURE__ */ jsx(Text, { className: styles$6.description, "data-visible": visible, as: "p", children: description2 }),
      /* @__PURE__ */ jsx(Text, { className: styles$6.description, "data-visible": visible, as: "p", children: impact }),
      /* @__PURE__ */ jsxs(Text, { className: styles$6.description, "data-visible": visible, as: "p", children: [
        /* @__PURE__ */ jsx("b", { children: "Tech Stack: " }),
        techstack
      ] }),
      /* @__PURE__ */ jsxs("div", { className: styles$6.button, "data-visible": visible, children: [
        techstackIcons && /* @__PURE__ */ jsx("div", { className: styles$6.techstackContainer, children: techstackIcons }),
        /* @__PURE__ */ jsx(Button, { iconHoverShift: true, href: buttonLink, iconEnd: "arrow-right", children: buttonText })
      ] })
    ] });
  }
  function renderPreview(visible) {
    return /* @__PURE__ */ jsxs("div", { className: styles$6.preview, children: [
      model2.type === "laptop" && /* @__PURE__ */ jsx(Fragment$1, { children: /* @__PURE__ */ jsxs("div", { className: styles$6.model, "data-device": "laptop", children: [
        !modelLoaded && /* @__PURE__ */ jsx(Loader, { center: true, className: styles$6.loader, "data-visible": visible }),
      ...
      model2.type === "phone" && /* @__PURE__ */ jsx(Fragment$1, { children: /* @__PURE__ */ jsxs("div", { className: styles$6.model, "data-device": "phone", children: [
        !modelLoaded && /* @__PURE__ */ jsx(Loader, { center: true, className: styles$6.loader, "data-visible": visible }),
        isHydrated && visible && /* @__PURE__ */ jsx(Suspense, { children: /* @__PURE__ */ jsx(
          Model,
          {
  ...
  return /* @__PURE__ */ jsx(
    Section,
    {
      ...
      tabIndex: -1,
      ...rest,
      children: /* @__PURE__ */ jsx("div", { className: styles$6.content, children: /* @__PURE__ */ jsx(Transition, { in: sectionVisible || focused, children: ({ visible }) => /* @__PURE__ */ jsxs(Fragment$1, { children: [
...
const workExperience = "_workExperience_1f3l1_20";
const timeline = "_timeline_1f3l1_26";
const timelineItem = "_timelineItem_1f3l1_40";
const dateColumn = "_dateColumn_1f3l1_45";
const date = "_date_1f3l1_45";
const card = "_card_1f3l1_63";
const cardHeader = "_cardHeader_1f3l1_91";
const logo = "_logo_1f3l1_98";
const headerText = "_headerText_1f3l1_108";
const company = "_company_1f3l1_114";
const role = "_role_1f3l1_121";
const location = "_location_1f3l1_127";
const responsibilities = "_responsibilities_1f3l1_139";
const responsibilityText = "_responsibilityText_1f3l1_144";
const styles$5 = {
  workExperience,
  timeline,
  timelineItem,
...
const unimelbLogo = "/final-portfolio/assets/unimelb-logo-D_0ik4Je.jpg";
const sensureLogo = "/final-portfolio/assets/sensure-logo-Bcs6xJ79.png";
const wehiLogo = "/final-portfolio/assets/wehi-logo-DgiZe6ie.jpg";
const scorklLogo = "/final-portfolio/assets/scorkl-logo-BlmKEBxT.png";
const WorkExperience = () => {
  ...
  return /* @__PURE__ */ jsx("div", { className: styles$5.workExperience, children: /* @__PURE__ */ jsx("div", { className: styles$5.timeline, children: experiences.map((exp, index2) => /* @__PURE__ */ jsxs("div", { className: styles$5.timelineItem, children: [
    /* @__PURE__ */ jsx("div", { className: styles$5.dateColumn, children: /* @__PURE__ */ jsxs("div", { className: styles$5.date, children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: styles$5.card, children: [
      /* @__PURE__ */ jsxs("div", { className: styles$5.cardHeader, children: [
        /* @__PURE__ */ jsx(
          "img",
          {
            src: exp.logoUrl,
        ...
        /* @__PURE__ */ jsxs("div", { className: styles$5.headerText, children: [
          /* @__PURE__ */ jsx("span", { className: styles$5.company, children: exp.company }),
          /* @__PURE__ */ jsx("span", { className: styles$5.role, children: exp.role })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: styles$5.location, children: [
        /* @__PURE__ */ jsx(MapPin, { size: 14 }),
        /* @__PURE__ */ jsx("span", { children: exp.location })
      ] }),
      /* @__PURE__ */ jsx("ul", { className: styles$5.responsibilities, children: exp.responsibilities.map((resp, respIndex) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx("p", { className: styles$5.responsibilityText, children: resp }) }, respIndex)) })
    ] })
  ] }, index2)) }) });
};
const WorkExperience$1 = WorkExperience;
const home = "_home_o6ir2_1";
const navLink = "_navLink_o6ir2_5";
const navIcons = "_navIcons_o6ir2_48";
const navIconLink = "_navIconLink_o6ir2_72";
const navIcon = "_navIcon_o6ir2_48";
const styles$4 = {
  home,
  navLink,
  navIcons,
...
const icon = "_icon_tnszt_1";
const styles$3 = {
  icon
};
const IconButton = ({ file, ...props }) => {
  return /* @__PURE__ */ jsx("img", { src: file, className: styles$3.icon, width: 30, ...props });
};
const profile = "_profile_tgaww_1";
const content = "_content_tgaww_36";
const column = "_column_tgaww_49";
const title = "_title_tgaww_58";
const description = "_description_tgaww_69";
const tag = "_tag_tgaww_79";
const tagText = "_tagText_tgaww_92";
const image = "_image_tgaww_113";
const svg = "_svg_tgaww_118";
const button = "_button_tgaww_134";
const styles$2 = {
  profile,
  content,
  column,
...
const ConnectMsg = ({ visible, titleId }) => /* @__PURE__ */ jsxs(Fragment, { children: [
  /* @__PURE__ */ jsx(Heading, { className: styles$2.title, "data-visible": visible, level: 3, id: titleId, children: /* @__PURE__ */ jsx(DecoderText, { text: "Let's connect!", start: visible, delay: 500 }) }),
...
const Connect = ({ id, visible, sectionRef }) => {
  const [focused, setFocused] = useState(false);
  const titleId = `${id}-title`;
  return /* @__PURE__ */ jsx(
    Section,
    {
      ...
      "aria-labelledby": titleId,
      tabIndex: -1,
      children: /* @__PURE__ */ jsx(Transition, { in: visible || focused, timeout: 0, children: ({ visible: visible2, nodeRef }) => /* @__PURE__ */ jsx("div", { className: styles$2.content, ref: nodeRef, children: /* @__PURE__ */ jsx("div", { className: styles$2.column, children: /* @__PURE__ */ jsx(ConnectMsg, { visible: visible2, titleId }) }) }) })
    }
  );
};
const swiftIcon = "/final-portfolio/assets/swift-DuA0Ds19.png";
const swiftUIIcon = "/final-portfolio/assets/swiftui-szxF6oUs.png";
const coreDataIcone = "/final-portfolio/assets/core-data-Bt_Cqe4_.png";
const sqliteIcon = "/final-portfolio/assets/sqlite-1d15fgxT.png";
const unityIcon = "/final-portfolio/assets/unity-logo-CqHDfWkN.png";
const cSharpIcon = "/final-portfolio/assets/c-sharp-logo-B54Iedo9.png";
const hlslIcon = "/final-portfolio/assets/hlsl-logo-Bu1E02Vt.jpg";
const tkinterIcon = "/final-portfolio/assets/tkinter-C4eG3h-H.png";
const pythonIcon = "/final-portfolio/assets/python-DLl3wObG.png";
const tensorIcon = "/final-portfolio/assets/tensorflow-BWNxZjJb.png";
const jupyterIcon = "/final-portfolio/assets/jupyter-CtP5H4QH.png";
const sleepybell1 = "/final-portfolio/assets/sleepybell_1-C3AkNcVx.gif";
const sleepybell2 = "/final-portfolio/assets/sleepybell_2-DZ6F3SSn.gif";
const lastman = "/final-portfolio/assets/last-man-CqwQwyib.png";
const ttt = "/final-portfolio/assets/tictactoe-DadTh8F_.png";
const links = () => {
  return [
    {
      rel: "prefetch",
...
const Home = () => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: styles$4.home, children: [
    ...
    /* @__PURE__ */ jsx(ProjectSectionContent, { children: /* @__PURE__ */ jsx(ProjectTextRow, { center: true, children: /* @__PURE__ */ jsx(ProjectSectionHeading, { children: "My Work Experience" }) }) }),
    /* @__PURE__ */ jsx("div", { className: styles$4.sectionTitle }),
    /* @__PURE__ */ jsx(WorkExperience$1, {}),
    /* @__PURE__ */ jsx(
      ProjectSummary,
      {
        id: "project-1",
        ...
        description: /* @__PURE__ */ jsxs(Fragment$1, { children: [
          "SleepyBell is a modern, feature-rich alarm clock and sleep tracking application designed for iOS devices. Built using ",
          /* @__PURE__ */ jsx("b", { children: "SwiftUI" }),
          " and",
          " ",
          /* @__PURE__ */ jsx("b", { children: "native iOS frameworks" }),
          ", SleepyBell not only allows users to set and manage multiple alarms but also collects, aggregates, and visualizes sleep data. Its sleek, intuitive interface and robust functionality make it a powerful tool for anyone looking to improve their sleep habits and wake up on time."
        ] }),
        buttonText: "View Project",
        buttonLink: "https://github.com/JoeyHammoth/SleepyBell",
        techstack: "SwiftUI, Swift, Core Data, SQLite",
        techstackIcons: /* @__PURE__ */ jsxs(Fragment$1, { children: [
          /* @__PURE__ */ jsx(IconButton, { file: swiftUIIcon }),
          /* @__PURE__ */ jsx(IconButton, { file: swiftIcon }),
          /* @__PURE__ */ jsx(IconButton, { file: coreDataIcone }),
          /* @__PURE__ */ jsx(IconButton, { file: sqliteIcon })
        ] }),
        model: {
          type: "phone",
    ...
    /* @__PURE__ */ jsx(
      ProjectSummary,
      {
        ...
        description: /* @__PURE__ */ jsxs(Fragment$1, { children: [
          "Developed in ",
          /* @__PURE__ */ jsx("b", { children: "Unity3D" }),
          ", The Last Man Standing is a 2.5D hack-and-slash survival game that leverages custom ",
          /* @__PURE__ */ jsx("b", { children: "ShaderLab" }),
          " ",
          "and ",
          /* @__PURE__ */ jsx("b", { children: "HLSL" }),
          " shaders for advanced visual effects. Core mechanics are implemented in ",
          /* @__PURE__ */ jsx("b", { children: "C#" }),
          ", featuring real-time physics, dynamic zombie AI, and a modular construction system for deploying shelters and obstacles."
        ] }),
        buttonText: "View Project",
        techstack: "Unity3D, ShaderLab, HLSL, C#",
        techstackIcons: /* @__PURE__ */ jsxs(Fragment$1, { children: [
          /* @__PURE__ */ jsx(IconButton, { file: unityIcon }),
          /* @__PURE__ */ jsx(IconButton, { file: cSharpIcon }),
          /* @__PURE__ */ jsx(IconButton, { file: hlslIcon })
        ] }),
    ...
    /* @__PURE__ */ jsx(
      ProjectSummary,
      {
        ...
        description: /* @__PURE__ */ jsxs(Fragment$1, { children: [
          "This is a Tic-Tac-Toe AI simulator developed in ",
          /* @__PURE__ */ jsx("b", { children: "Python" }),
          " using",
          " ",
          /* @__PURE__ */ jsx("b", { children: "Tkinter" }),
          "for the GUI, ",
          /* @__PURE__ */ jsx("b", { children: "TensorFlow" }),
          " for neural network support, and",
          " ",
          /* @__PURE__ */ jsx("b", { children: "Jupyter Notebook" }),
          " for interactive execution. It integrates four AI strategies—Random, Minimax (with configurable max depth), Monte Carlo Tree Search (with tunable exploration), and a Multilayer Perceptron (with adjustable iterations and training games). The simulator supports both human-AI and AI vs AI gameplay, with options to set the first player and a built-in scoring system."
        ] }),
        techstack: "Tkinter, Python, Jupyter Notebook, TensorFlow",
        techstackIcons: /* @__PURE__ */ jsxs(Fragment$1, { children: [
          /* @__PURE__ */ jsx(IconButton, { file: tkinterIcon }),
          /* @__PURE__ */ jsx(IconButton, { file: pythonIcon }),
          /* @__PURE__ */ jsx(IconButton, { file: jupyterIcon }),
          /* @__PURE__ */ jsx(IconButton, { file: tensorIcon })
        ] }),
        buttonText: "View project",
...
const usesBackgroundPlaceholder = "/final-portfolio/assets/uses-background-placeholder-ppC4yTdE.jpg";
const usesBackground = "/final-portfolio/assets/uses-background-DVBwh5G1.mp4";
...
const serverManifest = { "entry": { "module": "/final-portfolioassets/entry.client-BNmStyj3.js?client-route=1", "imports": ["/final-portfolioassets/jsx-runtime-DexIYAB0.js", "/final-portfolioassets/components-BuI-RKWx.js"], "css": [] }, "routes": { "root": { "id": "root", "parentId": void 0, "path": "", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": true, "module": "/final-portfolioassets/root-Be8vgp5n.js?client-route=1", "imports": ["/final-portfolioassets/jsx-runtime-DexIYAB0.js", "/final-portfolioassets/components-BuI-RKWx.js", "/final-portfolioassets/heading-B-J-pHfi.js", "/final-portfolioassets/index-Bmnn5a8H.js", "/final-portfolioassets/visually-hidden-BlT1z-Rl.js", "/final-portfolioassets/use-spring-BEVj5XCa.js", "/final-portfolioassets/decoder-text-1CbKvQXG.js", "/final-portfolioassets/image-BvzRmnxP.js", "/final-portfolioassets/error-DRryiajl.js", "/final-portfolioassets/useScrollToHash-EOES3fzI.js", "/final-portfolioassets/useWindowSize-mzNSXuUf.js", "/final-portfolioassets/config-TwLiQpRA.js"], "css": ["/final-portfolioassets/heading-DxmoR0-i.css", "/final-portfolioassets/image-CQFqa4Pm.css", "/final-portfolioassets/visually-hidden-DZKbrLgw.css", "/final-portfolioassets/decoder-text-DSqD8fOZ.css", "/final-portfolioassets/error-CmEnn51Q.css", "/final-portfolioassets/root-DnYBvntn.css"] }, "routes/articles.modern-styling-in-react": { "id": "routes/articles.modern-styling-in-react", "parentId": "routes/articles", "path": "modern-styling-in-react", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/final-portfolioassets/articles.modern-styling-in-react-DGKst1eD.js?client-route=1", "imports": ["/final-portfolioassets/jsx-runtime-DexIYAB0.js", "/final-portfolioassets/index-L_4ix5aQ.js"], "css": [] }, "routes/projects.volkihar-knight": { "id": "routes/projects.volkihar-knight", "parentId": "root", "path": "projects/volkihar-knight", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/final-portfolioassets/route-DdJcsd2Z.js?client-route=1", "imports": ["/final-portfolioassets/jsx-runtime-DexIYAB0.js", "/final-portfolioassets/components-BuI-RKWx.js", "/final-portfolioassets/heading-B-J-pHfi.js", "/final-portfolioassets/config-TwLiQpRA.js", "/final-portfolioassets/image-BvzRmnxP.js", "/final-portfolioassets/meta-DEolv56D.js", "/final-portfolioassets/useParallax-DfZmVu-F.js", "/final-portfolioassets/project-DYXlHuH7.js"], "css": ["/final-portfolioassets/heading-DxmoR0-i.css", "/final-portfolioassets/meta-PAfs1d9W.css", "/final-portfolioassets/image-CQFqa4Pm.css", "/final-portfolioassets/project-D3JpM_tk.css", "/final-portfolioassets/route-BT5UbU5w.css"] }, "routes/projects.smart-sparrow": { "id": "routes/projects.smart-sparrow", "parentId": "root", "path": "projects/smart-sparrow", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/final-portfolioassets/route-D_YcMAP-.js?client-route=1", "imports": ["/final-portfolioassets/jsx-runtime-DexIYAB0.js", "/final-portfolioassets/components-BuI-RKWx.js", "/final-portfolioassets/heading-B-J-pHfi.js", "/final-portfolioassets/config-TwLiQpRA.js", "/final-portfolioassets/image-BvzRmnxP.js", "/final-portfolioassets/meta-DEolv56D.js", "/final-portfolioassets/useParallax-DfZmVu-F.js", "/final-portfolioassets/spr-lesson-builder-dark-placeholder-CO51f6Yy.js", "/final-portfolioassets/link-DkLelLve.js", "/final-portfolioassets/visually-hidden-BlT1z-Rl.js", "/final-portfolioassets/project-DYXlHuH7.js"], "css": ["/final-portfolioassets/heading-DxmoR0-i.css", "/final-portfolioassets/meta-PAfs1d9W.css", "/final-portfolioassets/image-CQFqa4Pm.css", "/final-portfolioassets/link-D8crMWF7.css", "/final-portfolioassets/visually-hidden-DZKbrLgw.css", "/final-portfolioassets/project-D3JpM_tk.css", "/final-portfolioassets/route-PiXNUkZG.css"] }, "routes/articles.hello-world": { "id": "routes/articles.hello-world", "parentId": "routes/articles", "path": "hello-world", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/final-portfolioassets/articles.hello-world-YblCpcvN.js?client-route=1", "imports": ["/final-portfolioassets/jsx-runtime-DexIYAB0.js", "/final-portfolioassets/index-L_4ix5aQ.js"], "css": [] }, "routes/articles_._index": { "id": "routes/articles_._index", "parentId": "root", "path": "articles", "index": true, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/final-portfolioassets/route-Cltcd6wN.js?client-route=1", "imports": ["/final-portfolioassets/jsx-runtime-DexIYAB0.js", "/final-portfolioassets/components-BuI-RKWx.js", "/final-portfolioassets/heading-B-J-pHfi.js", "/final-portfolioassets/config-TwLiQpRA.js", "/final-portfolioassets/index-Bmnn5a8H.js", "/final-portfolioassets/visually-hidden-BlT1z-Rl.js", "/final-portfolioassets/use-spring-BEVj5XCa.js", "/final-portfolioassets/meta-DEolv56D.js", "/final-portfolioassets/decoder-text-1CbKvQXG.js", "/final-portfolioassets/divider-6dvt7X9v.js", "/final-portfolioassets/image-BvzRmnxP.js", "/final-portfolioassets/useWindowSize-mzNSXuUf.js", "/final-portfolioassets/date-DvyCAN0s.js"], "css": ["/final-portfolioassets/heading-DxmoR0-i.css", "/final-portfolioassets/meta-PAfs1d9W.css", "/final-portfolioassets/visually-hidden-DZKbrLgw.css", "/final-portfolioassets/decoder-text-DSqD8fOZ.css", "/final-portfolioassets/divider-CJ0zz9kw.css", "/final-portfolioassets/image-CQFqa4Pm.css", "/final-portfolioassets/route-DtSYASGB.css"] }, "routes/projects.slice": { "id": "routes/projects.slice", "parentId": "root", "path": "projects/slice", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/final-portfolioassets/route-B0wFE2m0.js?client-route=1", "imports": ["/final-portfolioassets/jsx-runtime-DexIYAB0.js", "/final-portfolioassets/components-BuI-RKWx.js", "/final-portfolioassets/heading-B-J-pHfi.js", "/final-portfolioassets/config-TwLiQpRA.js", "/final-portfolioassets/image-BvzRmnxP.js", "/final-portfolioassets/meta-DEolv56D.js", "/final-portfolioassets/useParallax-DfZmVu-F.js", "/final-portfolioassets/slice-app-placeholder-BfRsQMSa.js", "/final-portfolioassets/project-DYXlHuH7.js"], "css": ["/final-portfolioassets/heading-DxmoR0-i.css", "/final-portfolioassets/meta-PAfs1d9W.css", "/final-portfolioassets/image-CQFqa4Pm.css", "/final-portfolioassets/project-D3JpM_tk.css", "/final-portfolioassets/route-BMFIlMHl.css"] }, "routes/api.set-theme": { "id": "routes/api.set-theme", "parentId": "root", "path": "api/set-theme", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/final-portfolioassets/api.set-theme-l0sNRNKZ.js?client-route=1", "imports": [], "css": [] }, "routes/articles": { "id": "routes/articles", "parentId": "root", "path": "articles", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/final-portfolioassets/route-DlTDdGcX.js?client-route=1", "imports": ["/final-portfolioassets/jsx-runtime-DexIYAB0.js", "/final-portfolioassets/components-BuI-RKWx.js", "/final-portfolioassets/heading-B-J-pHfi.js", "/final-portfolioassets/config-TwLiQpRA.js", "/final-portfolioassets/divider-6dvt7X9v.js", "/final-portfolioassets/meta-DEolv56D.js", "/final-portfolioassets/image-BvzRmnxP.js", "/final-portfolioassets/useParallax-DfZmVu-F.js", "/final-portfolioassets/useScrollToHash-EOES3fzI.js", "/final-portfolioassets/clamp-e7DugykH.js", "/final-portfolioassets/date-DvyCAN0s.js", "/final-portfolioassets/link-DkLelLve.js", "/final-portfolioassets/list-DiqOkx00.js", "/final-portfolioassets/index-L_4ix5aQ.js"], "css": ["/final-portfolioassets/heading-DxmoR0-i.css", "/final-portfolioassets/divider-CJ0zz9kw.css", "/final-portfolioassets/meta-PAfs1d9W.css", "/final-portfolioassets/image-CQFqa4Pm.css", "/final-portfolioassets/link-D8crMWF7.css", "/final-portfolioassets/list-DkijDrbu.css", "/final-portfolioassets/route-CMd6_K8x.css"] }, "routes/contact": { "id": "routes/contact", "parentId": "root", "path": "contact", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/final-portfolioassets/route-BKGHlCcQ.js?client-route=1", "imports": ["/final-portfolioassets/jsx-runtime-DexIYAB0.js", "/final-portfolioassets/components-BuI-RKWx.js", "/final-portfolioassets/heading-B-J-pHfi.js", "/final-portfolioassets/index-Bmnn5a8H.js", "/final-portfolioassets/visually-hidden-BlT1z-Rl.js", "/final-portfolioassets/use-spring-BEVj5XCa.js", "/final-portfolioassets/config-TwLiQpRA.js", "/final-portfolioassets/decoder-text-1CbKvQXG.js", "/final-portfolioassets/divider-6dvt7X9v.js", "/final-portfolioassets/meta-DEolv56D.js"], "css": ["/final-portfolioassets/heading-DxmoR0-i.css", "/final-portfolioassets/visually-hidden-DZKbrLgw.css", "/final-portfolioassets/decoder-text-DSqD8fOZ.css", "/final-portfolioassets/divider-CJ0zz9kw.css", "/final-portfolioassets/meta-PAfs1d9W.css", "/final-portfolioassets/route-DZ4V55Yk.css"] }, "routes/home": { "id": "routes/home", "parentId": "root", "path": "home", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/final-portfolioassets/route-DdzapRtE.js?client-route=1", "imports": ["/final-portfolioassets/jsx-runtime-DexIYAB0.js", "/final-portfolioassets/components-BuI-RKWx.js", "/final-portfolioassets/heading-B-J-pHfi.js", "/final-portfolioassets/config-TwLiQpRA.js", "/final-portfolioassets/index-Bmnn5a8H.js", "/final-portfolioassets/visually-hidden-BlT1z-Rl.js", "/final-portfolioassets/use-spring-BEVj5XCa.js", "/final-portfolioassets/image-BvzRmnxP.js", "/final-portfolioassets/meta-DEolv56D.js", "/final-portfolioassets/useParallax-DfZmVu-F.js", "/final-portfolioassets/slice-app-placeholder-BfRsQMSa.js", "/final-portfolioassets/spr-lesson-builder-dark-placeholder-CO51f6Yy.js", "/final-portfolioassets/decoder-text-1CbKvQXG.js", "/final-portfolioassets/useScrollToHash-EOES3fzI.js", "/final-portfolioassets/divider-6dvt7X9v.js", "/final-portfolioassets/useWindowSize-mzNSXuUf.js", "/final-portfolioassets/project-DYXlHuH7.js", "/final-portfolioassets/route-DXpIWjrc.js"], "css": ["/final-portfolioassets/heading-DxmoR0-i.css", "/final-portfolioassets/meta-PAfs1d9W.css", "/final-portfolioassets/visually-hidden-DZKbrLgw.css", "/final-portfolioassets/decoder-text-DSqD8fOZ.css", "/final-portfolioassets/image-CQFqa4Pm.css", "/final-portfolioassets/divider-CJ0zz9kw.css", "/final-portfolioassets/project-D3JpM_tk.css", "/final-portfolioassets/route-BMecotIF.css"] }, "routes/uses": { "id": "routes/uses", "parentId": "root", "path": "uses", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/final-portfolioassets/route-fS95RNIk.js?client-route=1", "imports": ["/final-portfolioassets/jsx-runtime-DexIYAB0.js", "/final-portfolioassets/components-BuI-RKWx.js", "/final-portfolioassets/heading-B-J-pHfi.js", "/final-portfolioassets/config-TwLiQpRA.js", "/final-portfolioassets/image-BvzRmnxP.js", "/final-portfolioassets/meta-DEolv56D.js", "/final-portfolioassets/useParallax-DfZmVu-F.js", "/final-portfolioassets/link-DkLelLve.js", "/final-portfolioassets/list-DiqOkx00.js", "/final-portfolioassets/project-DYXlHuH7.js"], "css": ["/final-portfolioassets/heading-DxmoR0-i.css", "/final-portfolioassets/meta-PAfs1d9W.css", "/final-portfolioassets/link-D8crMWF7.css", "/final-portfolioassets/list-DkijDrbu.css", "/final-portfolioassets/image-CQFqa4Pm.css", "/final-portfolioassets/project-D3JpM_tk.css", "/final-portfolioassets/route-CJWqkCSj.css"] }, "routes/$": { "id": "routes/$", "parentId": "root", "path": "*", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": true, "module": "/final-portfolioassets/_-DNBKk9A0.js?client-route=1", "imports": ["/final-portfolioassets/jsx-runtime-DexIYAB0.js", "/final-portfolioassets/components-BuI-RKWx.js", "/final-portfolioassets/heading-B-J-pHfi.js", "/final-portfolioassets/index-Bmnn5a8H.js", "/final-portfolioassets/visually-hidden-BlT1z-Rl.js", "/final-portfolioassets/use-spring-BEVj5XCa.js", "/final-portfolioassets/decoder-text-1CbKvQXG.js", "/final-portfolioassets/image-BvzRmnxP.js", "/final-portfolioassets/error-DRryiajl.js"], "css": ["/final-portfolioassets/heading-DxmoR0-i.css", "/final-portfolioassets/visually-hidden-DZKbrLgw.css", "/final-portfolioassets/decoder-text-DSqD8fOZ.css", "/final-portfolioassets/image-CQFqa4Pm.css", "/final-portfolioassets/error-CmEnn51Q.css"] }, "routes/home/route": { "id": "routes/home/route", "parentId": "root", "path": "/", "index": true, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/final-portfolioassets/route-DdzapRtE.js?client-route=1", "imports": ["/final-portfolioassets/jsx-runtime-DexIYAB0.js", "/final-portfolioassets/components-BuI-RKWx.js", "/final-portfolioassets/heading-B-J-pHfi.js", "/final-portfolioassets/config-TwLiQpRA.js", "/final-portfolioassets/index-Bmnn5a8H.js", "/final-portfolioassets/visually-hidden-BlT1z-Rl.js", "/final-portfolioassets/use-spring-BEVj5XCa.js", "/final-portfolioassets/image-BvzRmnxP.js", "/final-portfolioassets/meta-DEolv56D.js", "/final-portfolioassets/useParallax-DfZmVu-F.js", "/final-portfolioassets/slice-app-placeholder-BfRsQMSa.js", "/final-portfolioassets/spr-lesson-builder-dark-placeholder-CO51f6Yy.js", "/final-portfolioassets/decoder-text-1CbKvQXG.js", "/final-portfolioassets/useScrollToHash-EOES3fzI.js", "/final-portfolioassets/divider-6dvt7X9v.js", "/final-portfolioassets/useWindowSize-mzNSXuUf.js", "/final-portfolioassets/project-DYXlHuH7.js", "/final-portfolioassets/route-DXpIWjrc.js"], "css": ["/final-portfolioassets/heading-DxmoR0-i.css", "/final-portfolioassets/meta-PAfs1d9W.css", "/final-portfolioassets/visually-hidden-DZKbrLgw.css", "/final-portfolioassets/decoder-text-DSqD8fOZ.css", "/final-portfolioassets/image-CQFqa4Pm.css", "/final-portfolioassets/divider-CJ0zz9kw.css", "/final-portfolioassets/project-D3JpM_tk.css", "/final-portfolioassets/route-BMecotIF.css"] } }, "url": "/final-portfolioassets/manifest-1122360c.js", "version": "1122360c" };
const mode = "production";
const assetsBuildDirectory = "build/client";
const basename = "/";
const future = { "v3_fetcherPersist": false, "v3_relativeSplatPath": false, "v3_throwAbortReason": false };
const isSpaMode = false;
const publicPath = "/final-portfolio";
